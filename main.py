...
def spawnClerk(page: ft.Page, user):
    ...
    packageFirstNameField = ft.TextField(max_length=50, label="Required")
    packageLastNameString = ft.Text("Last Name: ")
    packageLastNameField = ft.TextField(max_length=50, label="Required")
    packageOrganisationString = ft.Text("Organization: ")
    packageOrganisationField = ft.TextField(max_length=255, label="Optional")
    packageAdminAreaString = ft.Text("Administrative Area: ")
    packageAdminAreaField = ft.TextField(max_length=50, label="Required")
    packageLocalityString = ft.Text("Locality: ")
    packageLocalityField = ft.TextField(max_length=50, label="Required")
    packagePostalCodeString = ft.Text("Postal Code: ")
    packagePostalCodeField = ft.TextField(max_length=50, label="Required")
    packageThoroughfareString = ft.Text("Thoroughfare: ")
    packageThoroughfareField = ft.TextField(max_length=255, label="Required")
    packagePremiseString = ft.Text("Premise: ")
    packagePremiseField = ft.TextField(max_length=255, label="Optional")
    packageCountryString = ft.Text("Country: ")
    packageCountryField = ft.TextField(max_length = 2, label="Required")
